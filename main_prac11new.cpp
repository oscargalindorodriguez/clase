...
float posX = 0, posY = 2.5, posZ = -3.5, rotRodIzq = 0, rotRodDer = 0, rotCodIzq = 0, rotCodDer = 0, rotCue = 0, rotCabeza = 0;
float giroMonito = 0;
...
void interpolation(void)
{
	...
	KeyFrame[playIndex].rotCodDerInc = (KeyFrame[playIndex + 1].rotCodDer - KeyFrame[playIndex].rotCodDer) / i_max_steps;
	KeyFrame[playIndex].rotCodIzqInc = (KeyFrame[playIndex + 1].rotCodIzq - KeyFrame[playIndex].rotCodIzq) / i_max_steps;
...
void animacion()
{
	...
	if (play)
	{
		...
		else
		{
			...
			rotCodDer += KeyFrame[playIndex].rotCodDerInc;
			rotCodIzq += KeyFrame[playIndex].rotCodIzqInc;
			rotCue += KeyFrame[playIndex].rotCueInc;
			rotCabeza += KeyFrame[playIndex].rotCabezaInc;
			//inserta codigo de clase
			i_curr_steps++;
		}
